...
//     setIsVisible(!isVisible); // Trigger exit animation
//   };
...
//   return (
//     <div className="">
//       <div className=" flex  justify-between max-sm:grid max-sm:grid-cols-2 items-center max-md:ml-0 max-md:w-full max-sm:gap-3">
//         {!displayIndex&&displayIndex!==0&&<span></span>}
//         {displayIndex !==null&&<h2 className=" text-xl">{displayText[displayIndex]}</h2>}
...
//             <div className="" onClick={() => displayClickHandler(index)}>{text}</div>
...
//       <div
//         className={`displayArea transition-all ease-in-out duration-300 ${
//           isVisible && displayIndex === 0 ? "opacity-100 h-auto" : "opacity-0 max-h-0"
//         }`}
//       >
//         {/* <h1 className="text-xl">Amenities</h1> */}
//         <div>
...
//       <div
//         className={`displayArea transition-all ease-in-out duration-300 ${
//           isVisible && displayIndex === 2 ? "opacity-100 h-auto" : "opacity-0 max-h-0"
//         }`}
//       >
//         <ReviewPage busDetails={busDetails} />
//       </div>
...
//       <div
//         className={`displayArea transition-all ease-in-out duration-300 ${
//           isVisible && displayIndex === 4 ? "opacity-100 h-auto " : "opacity-0 max-h-0"
//         }`}
//       >
//         <ViewSeat
//           filledSeats={filledSeats}
